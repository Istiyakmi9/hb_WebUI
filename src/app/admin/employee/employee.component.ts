...
export class EmployeeComponent implements OnInit {
  ...
  arrangeDetails(flag: any, FieldName: string) {
    ...
    if (FieldName == 'firstName') this.orderByFirstNameAsc = !flag;
    if (FieldName == 'mobile') this.orderByMobileAsc = !flag;
    if (FieldName == 'email') this.orderByEmailAsc = !flag;
    if (FieldName == 'city') this.orderByCityAsc = !flag;
    if (FieldName == 'country') this.orderByCountryAsc = !flag;
    this.employeeData = new Filter();
  ...
  filterRecords() {
    ...
    if (
      this.employeeDetails.firstName !== null &&
  ...
  resetFilter() {
    ...
    this.employeeData.endIndex =
      this.employeeData.pageSize * this.employeeData.pageIndex;
    this.loadData();
    this.employeeDetails.firstName = '';
    this.employeeDetails.email = '';
    this.employeeDetails.mobile = '';
