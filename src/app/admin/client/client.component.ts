...
export class ClientComponent implements OnInit {
  ...
  constructor(private http: AjaxService, private nav: iNavigation) {}
  ...
  arrangeDetails(flag: any, FieldName: string) {
    ...
    if (FieldName == 'CompanyName') this.orderByNameAsc = !flag;
    if (FieldName == 'Mobile') this.orderByMobileAsc = !flag;
    if (FieldName == 'Email') this.orderByEmailAsc = !flag;
    if (FieldName == 'ClientTypeId') this.orderByClientTypeAsc = !flag;
    if (FieldName == 'Address') this.orderByAddressAsc = !flag;
  ...
  filterRecords() {
    ...
    if (
      this.clientDetails.CompanyName !== null &&
    ...
    if (
      this.clientDetails.ClientTypeId !== null &&
    ...
    if (
      this.clientDetails.Address !== null &&
  ...
  resetFilter() {
    ...
    this.clientsData.endIndex =
      this.clientsData.pageSize * this.clientsData.pageIndex;
    this.loadData();
    this.clientDetails.CompanyName = '';
