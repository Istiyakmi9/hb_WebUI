...
export class NavbarComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    google.accounts.id.initialize({
      client_id:
        '622966386962-pcep2a9p2l0j75p1nrl5m7clhlln3eil.apps.googleusercontent.com',
  ...
  showPassword(e: any) {
    e.currentTarget.previousElementSibling.previousElementSibling.removeAttribute(
      'type'
    );
    e.currentTarget.previousElementSibling.previousElementSibling.setAttribute(
      'type',
      'text'
    );
